...
def main():
    ...
    your_app_client_id = config['client_id']
    your_app_client_secret = config['secret']
    ...
    r.record_title = 'exampleEmotiv' # required param and can not be empty
    r.record_description = '' # optional param

    # input params for export_record. Please see on_warn_cortex_stop_all_sub()
    r.record_export_folder = '/Users/klau/Classes/csc570-affec/asgn3/affec-asgn3' # your place to export, you should have write permission, example on desktop
